...
@ConditionalOnProperty(prefix = "search.helper.rsql", name = "enabled", havingValue = "true", matchIfMissing = true)
class SearchRsqlAutoConfiguration {
    @Bean
    ...
    @Bean
    @ConditionalOnMissingBean
    public PerplexhubRsqlBackendOptions perplexhubRsqlBackendOptions(SearchHelperProperties properties) {
        SearchHelperProperties.Rsql.Perplexhub perplexhub = properties.getRsql().getPerplexhub();
