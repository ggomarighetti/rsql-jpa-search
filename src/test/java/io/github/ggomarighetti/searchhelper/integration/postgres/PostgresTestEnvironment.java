...
public final class PostgresTestEnvironment {
    private static final String DATABASE = "search_helper";
    private static final String USERNAME = "search_helper";
    private static final String PASSWORD = "search_helper";
